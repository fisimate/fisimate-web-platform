...
import { FiChevronDown, FiDatabase, FiUser } from "react-icons/fi";
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <SidebarMenu>
              ...
              <SidebarItem href={"/students"} text={"Siswa"}>
                <HiOutlineUserGroup />
              </SidebarItem>
              <SidebarItem href={"/chapters"} text={"Bab"}>
                <RiBookOpenLine />
              </SidebarItem>
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/banks" || pathname.includes("banks")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/banks/exams" && "text-white"
                              }`}
                            >
                              Bank Soal
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/banks/formulas"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/banks/formulas" && "text-white"
                              }`}
                            >
                              Bank Rumus
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/banks/materials"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/banks/materials" && "text-white"
                              }`}
                            >
                              Bank Materi
                            </Link>
